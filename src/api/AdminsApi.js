...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.IotaDashboardApi.AdminsApi = factory(root.IotaDashboardApi.ApiClient, root.IotaDashboardApi.Transaction);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/AdminsApi~addTransactionCallback
     ...
     * @param {module:model/Transaction} opts.transaction Transaction to add
     * @param {module:api/AdminsApi~addTransactionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Transaction}
     */
    this.addTransaction = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['transaction'];
