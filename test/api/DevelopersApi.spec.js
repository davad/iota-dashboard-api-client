...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IotaDashboardApi.DevelopersApi();
  });
  ...
  describe('DevelopersApi', function() {
    describe('getAllTransaction', function() {
      it('should call getAllTransaction successfully', function(done) {
        //uncomment below and update the code to test getAllTransaction
        //instance.getAllTransaction(pet, function(error) {
    ...
    describe('getTransaction', function() {
      it('should call getTransaction successfully', function(done) {
        ...
        //instance.getTransaction(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
